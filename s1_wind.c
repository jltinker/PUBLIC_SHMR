...
#define SEARCH_MIN_ITER 1000
#define GRAD_NORM 1e-3
...
extern double values[N_VALUES];
 ...
 /* wind data kobe-20110801 */
        g_s11 = 0.662125; g_s12 = 0.274563; g_s22 = 0.337875; g_s1 = 0.317564; g_s2 = -0.020188;

        /* wind data kobe-20111201 
        g_s11 = 0.502115; g_s12 = 0.279934; g_s22 = 0.497885; g_s1 = 0.566881; g_s2 = 0.617135; 
        */

        /* data from fb.ml 
        g_s11 = 0.012; g_s12 = 0.313; g_s22 = -0.043; g_s1  = 0.501; g_s2  = -0.035; 
        */

        /*
        g_x11 = -3; g_x12 = 0.5; g_x22 = 0.15; g_y1 = 1; g_y2 = 0.15; g_r = 1.0;
        */
...
do {
	...
	status = gsl_multimin_test_gradient(s->gradient, GRAD_NORM);
